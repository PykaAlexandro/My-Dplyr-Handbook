...
When applying a verb to a grouped data frame, the rows' order of the output can be modified, most frequently by arranging them by the grouping columns. The grouping columns can be retrieved at any time using `group_keys()`, a grouped data frames utility function.
